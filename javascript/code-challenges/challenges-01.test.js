...
------------------------------------------------------------------------------------------------ */
let addOneArray =[1,2,3,4,5];

const addOne = (arr1) => {
  let addOneArrayNew = [];
  arr1.forEach(number => addOneArrayNew.push(number +1));
  return addOneArrayNew;
};
...
const addExclamation = (arr2) => {
  let newArray2 =[];
  arr2.forEach(string => newArray2.push(string + '!'));
  return newArray2;
};
...
const allUpperCase = (arr3) => {
  let newArray3 =[];
  arr3.forEach(string => newArray3.push(string.toUpperCase()));
  return newArray3;
};
...
const greeting = (word) => {
  let ahoy = `${word.toUpperCase()}!`;
  return ahoy;
};

const speaker = (words, callback) => {
  let newArray4 =[];
  words.forEach(string => newArray4.push(callback(string)));
  return newArray4;
};
